...
<div class="video-list-container">
    <h3 class="list-headline">Header für Shake One: Wat is schon dran an som Tach</h3>
...
<div class="soundcloud-list-container">
    <h3 class="list-headline">Für den Liebeskummer Cruiser durch die Sonne: Bobby Oroza - This Love</h3>
...
<div class="soundcloud-list-container">
    <h3 class="list-headline">Versatile mixture of relaxed, lost in thougt and lift the spirit Vibrations: Reverberation Radio #398</h3>
    <div class="soundcloud-container ">
        <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay"
...
<div class="soundcloud-list-container">
    <h3 class="list-headline">Just take a break and relax in Bikini Bottom: Subjectives - No.29</h3>
    <div class="soundcloud-container ">
        <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay"
...
<div class="video-list-container">
    <h3 class="list-headline">Wenn dir mal wieder alles über den Kopf wächst: Du musst gar nix - Die Sterne</h3>
    <div class="video-container ">
