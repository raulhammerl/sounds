...
<ul class="video-list">
<li class="video-list">
    <p class="list-tile">Header für Shake One</p>
...
<li class="video-list">
    <p class="list-tile">Für den Liebeskummer Cruiser durch die Sonne</p>
...
<li class="video-list">
    <p class="list-tile">Versatile mixture of relaxed, lost in thougt and lift the spirit Vibrations</p>
...
<li class="video-list">
    <p class="list-tile">Just take a break and relax in Bikini Bottom</p>
...
<li class="video-list">
    <p class="list-tile">Wenn dir mal wieder alles über den Kopf wächst</p>
